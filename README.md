...
En este repositorio, en la sección de [Issues](https://https://github.com/IIC2283-PUC/Dudas-Tareas-2026-2/issues) podrán hacer preguntas sobre las tareas del curso.
...
2. El codigo base proporcionado en cada problema puede ser cambiado en su totalidad a discreción del estudiante.

3. Si cree necesitar de alguna librería adicional, consultar antes de usarla. Como norma general, no se permitirán librerías que no estén incluidas en la librería estándar de Python.